...
Module to allow the creation of payments for external invoices (invoices
that don't exist as ``account.move`` records in this Odoo database).
...
* Dylan Silva <dylan.silva@arxi.pt>
