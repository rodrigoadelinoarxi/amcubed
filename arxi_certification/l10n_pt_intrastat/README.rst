...
==============================
Portugal - Certified Intrastat
==============================

* Adds a button in the Intrastat report to export a file with the format required by INE (WebINQ).

* Adds a configuration to hide/show intrastat country in invoice reports.
