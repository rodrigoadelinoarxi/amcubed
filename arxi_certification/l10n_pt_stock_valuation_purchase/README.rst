...
===================================
Portugal - Stock Valuation Purchase
===================================

This module implements account mapping in stock valuation:

- When an accout move from an stock valuation is created:
    * Map accounts depending on the fiscal position from purchase
